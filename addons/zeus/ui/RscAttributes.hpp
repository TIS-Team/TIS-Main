...
class GVAR(RscTfarRadioJammer): RscDisplayAttributes {
    onLoad = QUOTE([ARR_3('onLoad',_this,QQGVAR(RscTfarRadioJammer))] call FUNC(zeusAttributes));
    onUnload = QUOTE([ARR_3('onUnload',_this,QQGVAR(RscTfarRadioJammer))] call FUNC(zeusAttributes));
    class Controls: Controls {
        class Background: Background {};
        class Title: Title {};
        class Content: Content {
            class Controls {
                class controlsGroup: RscControlsGroupNoScrollbars {
                    onSetFocus = QUOTE(call FUNC(ui_tfarRadioJammer));
                    idc = -1;
                    x = 0;
                    y = 0;
                    w = QUOTE(W_PART(26));
